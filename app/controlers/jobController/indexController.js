...
//get form
exports.jobgetform = async (req, res) => {
    try {
        return res.render("job/home", {
            route: "formcrud",
...
//insert data
exports.jobinsertdata = async (req, res) => {
    try {
        ...
        if (!fname || !currdesignation || !email || !gender || !address || !state || !lname || !dob || !phone || !relnstatus || !city || !zipcode
            ...
            return res.render("job/home", {
                ...
                technologyknown: [], reference: [], preference: {}, message: "please fill all field"
            })
        }
        else {
            ...
            if (!(lang1 && langcheck1) && !(lang3 && langcheck3) && !(lang2 && langcheck2)) {
                return res.render("job/home", {
                    route: "/formcrud", basicdetail: null, educationdetial: [], workexperience: [], languageknown: [],
                    technologyknown: [], reference: [], preference: {}, message: "please choose one language"
                })
            }
            ...
            for (let i = 0; i < companyname.length; i++) {
                if ((!companyname[i] && (designation[i] || from[i] || to[i])) || (companyname[i] && (!designation[i] || !from[i] || !to[i]))) {
                    return res.render("job/home", {
                        route: "/formcrud", basicdetail: null, educationdetial: [], workexperience: [], languageknown: [],
                        technologyknown: [], reference: [], preference: {}, message: "please fill all field of selected company"
                    })
                }
            ...
            for (let i = 0; i < name.length; i++) {
                if ((!name[i] && (contactnum[i] || relation[i])) || (name[i] && (!contactnum[i] || !relation[i]))) {
                    return res.render("job/job/home", {
                        route: "/formcrud", basicdetail: null, educationdetial: [], workexperience: [], languageknown: [],
                        technologyknown: [], reference: [], preference: {}, message: "please fill all field of selected reference"
                    })
                }
            ...
            if (result.length == 1) {
                return res.render("job/home", {
                    route: "/formcrud", basicdetail: null, educationdetial: [], workexperience: [], languageknown: [],
                    technologyknown: [], reference: [], preference: {}, message: "user exist with same email"
                })
            }
            else {
                try {
                    let uid = await basicdetails(req, res);
                ...
                return res.render("job/home", {
                    route: "/formcrud", basicdetail: null, educationdetial: [], workexperience: [], languageknown: [],
                    technologyknown: [], reference: [], preference: {}, message: "data inserted sucessfully"
                })
...
exports.jobresult = async (req, res) => {
    try {
        ...
        return res.render("job/result", { result: result });
    } catch (error) {
        res.status(500).json({
            success: false,
            messege: error.message
...
exports.jobgetdataforupdate = async (req, res) => {
    try {
...
exports.jobupdateform = async (req, res) => {
    try {
        let { candid, fname, currdesignation, email, gender, address, state, lname, dob, phone, relnstatus,
            city, zipcode, sscnameofboard, sscpassingyear, sscpercentage, hscnameofboard, hscpassingyear,
            hscpercentage, bachelorcourse, bachelorpassingyear, bachelorpercentage, mastercourse,
        ...
        if (!fname || !currdesignation || !email || !gender || !address || !state || !lname || !dob || !phone || !relnstatus || !city || !zipcode
            ...
            return res.render("job/home", {
                route: "/updatecrud", basicdetail: null, educationdetial: [], workexperience: [], languageknown: [],
                technologyknown: [], reference: [], preference: {}, message: "please fill all field"
            })
        } else {
            ...
            if ((mastercourse && !bachelorcourse)) {
                return res.render("job/home", {
                    route: "/updatecrud", basicdetail: null, educationdetial: [], workexperience: [], languageknown: [],
                    technologyknown: [], reference: [], preference: {}, message: "Please fill Bachekor Degree Feild as You Fill Master Degree Field.."
                })
            }
            ...
            return res.redirect(`/updatecrud/${candid}`)
            // return res.render("job/home", {
