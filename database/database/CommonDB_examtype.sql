...
CREATE TABLE `examtype` (
  ...
  `totalmarksfortheory` int NOT NULL,
  `totalmarksforpractical` int NOT NULL,
  PRIMARY KEY (`examtype`)
...
INSERT INTO `examtype` VALUES (1,'final',80,20),(2,'prelims',40,10),(3,'terminal',40,10);
